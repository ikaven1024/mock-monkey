  ...
  class Panel {
    ...
    createToggleButton() {
      this.ensureBody().then(() => {
        ...
        btn.style.cssText = "position: fixed; bottom: 20px; right: 20px; width: 50px; height: 50px; border-radius: 50%; background: #f5f5f5; border: none; cursor: pointer; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.15); z-index: 999998; display: flex; align-items: center; justify-content: center; padding: 9px; transition: all 0.2s;";
