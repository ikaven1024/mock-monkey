  ...
  class Panel {
    ...
    createToggleButton() {
      this.ensureBody().then(() => {
        ...
        btn.style.cssText = "position: fixed; bottom: 20px; right: 20px; width: 50px; height: 50px; border-radius: 50%; background: #4f46e5; border: none; cursor: pointer; box-shadow: 0 4px 12px rgba(79, 70, 229, 0.4); z-index: 999998; display: flex; align-items: center; justify-content: center; padding: 9px;";
